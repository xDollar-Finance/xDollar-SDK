...
const maticDeployerAccount = process.env.MATIC_DEPLOYER_PRIVATE_KEY || Wallet.createRandom().privateKey;
...
const oracleAddresses = {
  ...
  matic: {
    ...
    tellor: "0xbc2f9E092ac5CED686440E5062D11D6543202B24" // Playground
  }
};
...
const wethAddresses = {
  ...
  matic: "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270" // WMATIC address in matic mainnet.
};
...
task("deploy", "Deploys the contracts to the network")
  ...
  .setAction(
    async ({ channel, gasPrice, useRealPriceFeed, createUniswapPair }: DeployParams, env) => {
      ...
      useRealPriceFeed ??= env.network.name === "matic";
