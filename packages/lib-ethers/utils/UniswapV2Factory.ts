...
// const factoryAddress = "0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32"; // Quickswap

const factoryAddress = "0xc35DADB65012eC5796536bD9864eD8773aBc74C4"; // Sushi in matic

const hasFactory = (chainId: number) => [1, 3, 4, 5, 42, 137].includes(chainId);
